#!/usr/bin/env python
"""
Stop P6 EPPM Managed Servers on prmapp01 via WLST
This script connects to the Admin Server and stops managed servers assigned to prmapp01
...
# Managed servers on prmapp01 (Host 1) - reverse order for graceful shutdown
managed_servers = [
    'p6cc_ms1',
    'p6tm_ms1',
    'p6ws_ms1',
...
try:
    print('=' * 60)
    print('P6 EPPM Managed Server Shutdown - prmapp01')
    print('=' * 60)
    print('')
